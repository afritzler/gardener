...
func (k *kubeScheduler) computeComponentConfig() (string, string, error) {
	...
	if version.VersionConstraintK8sGreaterEqual119.Check(k.version) {
		apiVersion = "kubescheduler.config.k8s.io/v1beta1"
	} else if version.VersionConstraintK8sGreaterEqual118.Check(k.version) {
...
func (k *kubeScheduler) computeCommand(port int32) []string {
	...
	if version.VersionConstraintK8sGreaterEqual117.Check(k.version) {
