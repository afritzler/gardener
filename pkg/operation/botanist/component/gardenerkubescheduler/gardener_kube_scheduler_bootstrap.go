...
func Bootstrap(
	...
	switch {
	case version.VersionConstraintK8sEqual118.Check(seedVersion):
	...
	case version.VersionConstraintK8sEqual119.Check(seedVersion):
	...
	case version.VersionConstraintK8sEqual120.Check(seedVersion):
